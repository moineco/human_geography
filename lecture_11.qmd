...
- You can download the data from this website or KUTLMS Moodle lecture contents.
...
#| code-fold: false
#| message: false
jp0_shp <- st_read("data/jpn_adm_2019_shp/jpn_admbnda_adm0_2019.shp")
jp1_shp <- st_read("data/jpn_adm_2019_shp/jpn_admbnda_adm1_2019.shp") 
jp2_shp <- st_read("data/jpn_adm_2019_shp/jpn_admbnda_adm2_2019.shp") 
```
